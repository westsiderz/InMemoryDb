...
namespace xq
{
    ...
    private:
        ...
        bool matchName(const DbTableTest& f_record) const;
        ...
        bool matchBalance(const DbTableTest& f_record) const;
        ...
        bool matchAddress(const DbTableTest& f_record) const;
